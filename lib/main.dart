...
//   final Color lightThemeAccent = const Color(0xFF142338);
...
//           extensions: <ThemeExtension<dynamic>>[
//             CustomColors(accentColor: const Color.fromARGB(255, 7, 5, 0), darkTextColor: const Color.fromARGB(255, 10, 0, 0)),
//           ],
//         ),
...
class MyApp extends StatelessWidget {
  ...
  // កែប្រែពណ៌ទាំងនេះដើម្បីឲ្យវាសមស្រប
  final Color lightThemeAccent = const Color(0xFF142338);
  final Color darkThemeAccent = const Color(0xFF98A6BC); // ពណ៌សមស្របសម្រាប់ dark mode
    ...
    return Obx(
      () => GetMaterialApp(
        ...
        darkTheme: ThemeData(
          fontFamily: 'Poppins',
          brightness: Brightness.dark,
          // កែប្រែពណ៌ផ្ទៃខាងក្រោយសម្រាប់ dark mode
          scaffoldBackgroundColor: const Color(0xFF1d1b20),
          extensions: <ThemeExtension<dynamic>>[
            // កែប្រែពណ៌សម្រាប់ dark mode
            CustomColors(accentColor: darkThemeAccent, darkTextColor: Colors.white),
          ],
        ),
        themeMode: ThemeMode.system,
        translations: MyTranslations(),
