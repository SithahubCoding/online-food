...
// import '../views/subcategory_screen.dart';
...
//       onTap: () => Get.to(() => SubCategoryOneScreen(food: food)),
//       child: MouseRegion(
...
//               ),
//               // Food Info
//               // ជំនួសកូដ Padding ដើមរបស់អ្នកជាមួយនឹងកូដនេះ
//               Padding(
...
class _CategoryScreenState extends State<CategoryScreen>
              ...
              children: [
                    ...
                    child: Container(
                      ...
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          hintText:
                              "Search by ID, Name, Category or SubCategory",
                          hintStyle: const TextStyle(color: Colors.black38),
                          suffixIcon: IconButton(
                            icon: const Icon(
                              Icons.clear,
                ...
                StreamBuilder<QuerySnapshot>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    return buildFoodGrid(foods, customColors);
                  },
                ),
              ],
            ),
  ...
  // Staggered Fade + Slide + Scale (zoom in) grid
  Widget buildFoodGrid(List<FoodModel> foods, CustomColors customColors) {
    return GridView.builder(
      physics: const NeverScrollableScrollPhysics(),
      shrinkWrap: true,
